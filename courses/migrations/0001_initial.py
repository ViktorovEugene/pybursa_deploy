    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.date(2015, 1, 19))),
                ('end_date', models.DateField()),
                ('tecnology', models.CharField(max_length=11, choices=[(b'python', b'Python'), (b'ruby', b'Ruby'), (b'javascript', b'JavaScript')])),
